...
// Function to initialise the farm
//
// Parameters:
// - farm: the 2D array representing the farm
//
...
// Function to place the farmer in the farm
//
// Parameters:
// - farm: the 2D array representing the farm
//
...
void place_farmer(struct farm_entity farm[SIZE][SIZE]) {
    ...
    while (row < 0 || row >= SIZE || col < 0 || col >= SIZE ||
           farm[row][col].entity != EMPTY) {
        printf("Invalid farmer position!\n");
        printf("Please re-enter the starting position of the farmer: ");
        scanf("%d %d", &row, &col);
    }
    farm[row][col].entity = FARMER;
    farm[row][col].points = 0;
...
// Function to place the barns and trees in the farm
//
// Parameters:
// - farm: the 2D array representing the farm
//
...
// Function to place the coops in the farm
//
// Parameters:
// - farm: the 2D array representing the farm
//
...
// Function to print the sum of the points in the farm
//
// Parameters:
// - farm: the 2D array representing the farm
//
...
void print_farm_sum(struct farm_entity farm[SIZE][SIZE]) {
    ...
    printf("The total points in the farm is: %d\n", sum);
}
